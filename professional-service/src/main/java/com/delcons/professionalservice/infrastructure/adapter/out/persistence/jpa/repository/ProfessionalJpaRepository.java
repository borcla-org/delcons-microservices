package com.delcons.professionalservice.infrastructure.adapter.out.persistence.jpa.repository;
...
public interface ProfessionalJpaRepository extends JpaRepository<ProfessionalEntity, Long> {
    ...
    Optional<ProfessionalEntity> findByNickname(String nickname);
}